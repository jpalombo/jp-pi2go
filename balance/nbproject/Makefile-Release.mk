...
${OBJECTDIR}/MotionSensor/balance.o: MotionSensor/balance.cpp 
	${MKDIR} -p ${OBJECTDIR}/MotionSensor
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionSensor/balance.o MotionSensor/balance.cpp
...
${OBJECTDIR}/MotionSensor/inv_mpu_lib/inv_mpu.o: MotionSensor/inv_mpu_lib/inv_mpu.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionSensor/inv_mpu_lib/inv_mpu.o MotionSensor/inv_mpu_lib/inv_mpu.c
...
${OBJECTDIR}/MotionSensor/pi2golite.o: MotionSensor/pi2golite.cpp 
	${MKDIR} -p ${OBJECTDIR}/MotionSensor
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionSensor/pi2golite.o MotionSensor/pi2golite.cpp
