...
${OBJECTDIR}/MotionSensor/main.o: MotionSensor/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/MotionSensor
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionSensor/main.o MotionSensor/main.cpp

${OBJECTDIR}/MotionSensor/monitor.o: MotionSensor/monitor.cpp 
	${MKDIR} -p ${OBJECTDIR}/MotionSensor
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MotionSensor/monitor.o MotionSensor/monitor.cpp
